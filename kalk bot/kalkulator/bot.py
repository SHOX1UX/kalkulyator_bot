...
async def help_commands(message:Message):
    await message.answer("Salom\nSiz bu bot orqali qiyin misollarni ko'paytirish bo'lish va hokazolarni hisoblab olishingiz mumkin")
...
async def about_commands(message:Message):
    await message.answer("Nma yozishshi bilmadm shunchun nma yozishshi bilmadm deb yozdm")
